...
+ (void)animationReveal:(UIView *)view direction:(NSString *)direction;         //揭开
+ (void)animationFade:(UIView *)view;                                           //渐隐渐消
+ (void)animationFlip:(UIView *)view direction:(NSString *)direction;           //翻转
+ (void)animationRotateAndScaleEffects:(UIView *)view;                          //各种旋转缩放效果
+ (void)animationRotateAndScaleDownUp:(UIView *)view;                           //旋转同时缩小放大效果
+ (void)animationPush:(UIView *)view direction:(NSString *)direction;           //push
+ (void)animationCurl:(UIView *)view direction:(NSString *)direction;           //Curl
+ (void)animationUnCurl:(UIView *)view direction:(NSString *)direction;         //UnCurl
+ (void)animationMove:(UIView *)view direction:(NSString *)direction;           //Move
+ (void)animationCube:(UIView *)view direction:(NSString *)direction;           //立方体
+ (void)animationRippleEffect:(UIView *)view;                                   //水波纹
+ (void)animationCameraEffect:(UIView *)view type:(NSString *)type;             //相机开合
+ (void)animationSuckEffect:(UIView *)view;                                     //吸收
